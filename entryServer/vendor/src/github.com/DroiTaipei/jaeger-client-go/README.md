...
```yaml
- package: github.com/DroiTaipei/jaeger-client-go
  version: ^2.7.0
```
...
```shell
go get -u github.com/DroiTaipei/jaeger-client-go/
cd $GOPATH/src/github.com/DroiTaipei/jaeger-client-go/
...
See tracer initialization examples in [godoc](https://godoc.org/github.com/DroiTaipei/jaeger-client-go/config#pkg-examples)
...
(https://github.com/DroiTaipei/opentracing-go) documentation.
...
```go
import (
    "github.com/DroiTaipei/opentracing-go"
...
[doc-img]: https://godoc.org/github.com/DroiTaipei/jaeger-client-go?status.svg
[doc]: https://godoc.org/github.com/DroiTaipei/jaeger-client-go
